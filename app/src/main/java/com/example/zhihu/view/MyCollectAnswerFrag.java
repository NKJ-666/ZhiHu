...
public class MyCollectAnswerFrag extends Fragment {
    private MyCollectAnswerBinding binding;
    ...
    public MyCollectAnswerFrag(MyDataBaseHelper helper, User user){
        this.helper = helper;
        this.user = user;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.my_collect_answer, container, false);
        init();
