...
public class MyFollowingQuestion extends Fragment {
    private MyFollowingQuestionBinding binding;
    ...
    public MyFollowingQuestion(MyDataBaseHelper helper, User user){
        this.helper = helper;
        this.user = user;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.my_following_question, container, false);
        init();
