...
public class MyApproveAnswerFrag extends Fragment {
    private MyApproveAnswerBinding binding;
    ...
    public MyApproveAnswerFrag(MyDataBaseHelper helper, User user){
        this.helper = helper;
        this.user = user;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.my_approve_answer, container, false);
        init();
